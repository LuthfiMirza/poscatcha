            ...
            <tbody>
              @foreach ($products as $product)                  
                <tr>
                    ...
                    <td><button wire:click="addToCart('{{ $product->id }}')" class="btn badge bg-success">Add</button></td>
                </tr>
              @endforeach
            </tbody>
          </table>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                @foreach ($carts as $cart)                 
                  <tr>
                    <th scope="row"><a href="#">{{ $cart->product_id }}</a></th>
                    ...
                    <td>Rp{{ number_format($cart->product_price * $cart->quantity) }}</td>
                    <td><button wire:click="removeFromCart('{{ $cart->id }}')" class="btn badge bg-danger">Delete</button></td>
                  </tr>
                @endforeach                
              </tbody>
            </table>
            ...
            @if (count($carts) > 0)
              <div class="border-top pt-3">
                ...
                <div class="d-grid gap-2 mt-3">
                  <button class="btn badge bg-warning" wire:click="addPendingOrder()">Pending</button>
                  <button 
