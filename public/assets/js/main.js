...
document
    ...
    // selling product process start

    // document.addEventListener('DOMContentLoaded', function () {
    //     const sellButton = document.querySelectorAll('btn-sell');
    //     const sellList = document.getElementById('sellList');

    //     sellButton.addEvenlisttener('click', function () {
    //         const productId = this.getAttribute('data-product-id');
    //         const productName = this.getAttribute('data-product-name');
    //         const productPrice = parseInt(this.getAttribute('data-price')).toLocaleString('id-ID', {
    //             style: 'currency',
    //             currency: 'IDR'
    //         });
    ...
    //         sellRow.innerHTML = `
    //             <th scope='row'><a href='#'>${{ productId }}</a></th>
    //             <td>${{ productName }}</td>
    //             <td>${{ productPrice }}</td>
